...
4. **Other lines:** Vicente's Portuguese parish (CIV-0007) — the São João Batista do Rio Claro
   ...
   **Diocese de Piracicaba** documental centre (C-010, replied 2026-09-10 with a paid
   "Solicitação de Pesquisa e Certidão" intake form) is a **paid fallback only — do not pay
   without the owner's go-ahead**; the João–Susanna Sapucaia ceremony
...
| Structured places | 9 |
| Structured sources | 168 |
| Structured FAN references | 13 |
| Retained evidence scans | 263 |
...
16. **OPEN — needs owner adjudication (2026-09-13):** the 1867 José Cesário de Toledo
    Lima inventário "heir 6" folha. A verbatim re-read reads "Pagamento feito ao herdeiro
    Simplicio José _de Tolledo_, de sua legítima _paterna_" — surname "de Toledo" (not
    "Armond") and a child receiving his own paternal share, i.e. plausibly the namesake
    son Simplício José Ferreira de Toledo, NOT Eliza's husband Simplício José Ferreira
    Armond. This puts the "1867 = earliest Armond×Toledo document" claim in question.
    Counter-arguments keep it live (the monte divides among "os oito herdeiros" and only
    ~30 of 188 folhas were sampled). NOT catalogued as Simplício Armond pending a full
    folha-by-folha re-read of all 188 folhas (both esboço + final passes). Eliza's own
    parentage is UNAFFECTED (conflict #14, the 1879 Matilde Título). Heir #8 (Geraldo
    Augusto vs Josepha Olimpia) is also provisional.
17. RESOLVED (2026-09-13): Alcida Fernandes de Azevedo's father in her 1975 Mesquita
    death (CIV-0051) reads "Ascendino Maria de Azevedo", conflicting with the modelled
    father José Secundino de Azevedo (P-0038). Resolved in favour of P-0038 — attested
    three times near-contemporarily with daughter Luiza as informant (CIV-0001 + PAR-0012,
