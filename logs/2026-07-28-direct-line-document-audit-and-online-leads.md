# Direct-line document audit and online Ferreira Armond leads
...
The repository owner requested a document-by-document verification of the
direct line beginning with the subject, and then authorised open-web and
FamilySearch research to close the remaining gaps. Every evidence file was
re-read from the retained image or PDF (poppler installed locally to render
PDFs). Open-web searches used a standard search engine and two published
family-history pages. No authenticated FamilySearch session was available this
session, so FamilySearch record images were not retrieved.
...
- Published family history (Mauro Senra, "Ferreira Armond — Uma Família
  ...
  with a daughter Marfisa baptised 15 February 1873 in Nossa Senhora da
  Piedade, Piacatuba (Leopoldina). This corroborates the fuller-name leads for
  P-0016 and P-0017 and the Piacatuba baptism target for Aristão.

## Negative results and limitations

- No public source names Aristão Ferreira Armond or Liliosa Paz Armond, or
  connects the documented line to the noble/Azorean Ferreira Armond group
  (Barbacena). The Azorean-origin claim remains a lead only.
- "Presidente Soares" was not confirmed as a Minas Gerais place name; open
  searches return only Raul Soares. PL-0009 requires verification and may be a
  misreading or a defunct locality name.
- No authenticated FamilySearch access this session: the original 1982 birth
  register, the Piacatuba baptism books, the Sapucaia marriage book and the
  1946 Volta Redonda death registers were not retrieved.

## Conclusions

Genealogical conclusions were not changed. Source transcriptions were corrected
to match their images, two reported births were structured as strong-evidence
events, and the online findings were recorded as unverified leads only.
